...
<body class="body">
    ...
    <header class="header">
        <img class="header__image" src="./img/logo-ies-1.svg" alt="logo sagaseta">
        <?php
            echo "<h1 class='header__text'>$diaSemana, ".DIA." a las ".HORA."</h1>";
        ?>
    </header>
    ...
    <footer class="footer">
        ...
        <div class="footer__text">
            <div class="footer__text__links">
                <a href="https://www3.gobiernodecanarias.org/medusa/edublog/iesfernandosagaseta/" class="footer_text_link">IES Fernando Sagaseta</a>
            </div>
            <p>Aileen Padrón Torres - IES Fernando Sagaseta</p>
        </div>
    </footer>
